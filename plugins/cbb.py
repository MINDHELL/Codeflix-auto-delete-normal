...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ ᴏᴡɴᴇʀ : <a href='tg://user?id={OWNER_ID}'>ᴍɪᴋᴇʏ</a>\n○ ᴍʏ ᴜᴘᴅᴀᴛᴇs : <a href='https://t.me/ALLVIDSBACKUP1>BACKUP</a>\n○ Support group: <a href='https://t.me/Xsupport_chats>SUPPORT</a>\n○ OWNER : <a href='https://t.me/XSUPPRT3BOT>OWNER</a>\n○ ADMIN : <a href='https://t.me/XSUPPRT3BOT>Admins</a></b>",
            disable_web_page_preview = True,
            reply_markup = InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton("⚡️ ᴄʟᴏsᴇ", callback_data = "close"),
                    InlineKeyboardButton('🍁 ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/XSUPPRT3BOT)
                    ]
                ]
            )
        )
